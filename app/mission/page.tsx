        ...
        <div className="space-y-12">
          <div>
            ...
            <p className="mt-4 leading-7 text-slate-700">
              The digital world changes quickly. New apps appear, platforms
              evolve, online trends spread fast, and risks often show up long
              before most families hear about them clearly. Parents are expected
              to keep up with all of it while also juggling everything else that
              comes with raising kids.
            </p>
            <p className="mt-4 leading-7 text-slate-700">
              That gap is exactly why KidSafe Index exists. We want to make it
              easier for parents to understand what is happening online, what
          ...
          <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm">
            ...
            <p className="mt-4 leading-7 text-slate-700">
              ...
              multi-million-dollar cybersecurity budget to better protect your
              family.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-slate-200/80 bg-sky-50/50 p-6 shadow-sm">
            ...
            <p className="mt-4 leading-7 text-slate-700">
              If you sign up for KidSafe Index updates, your information is used
              only to communicate with you about KidSafe Index.
            </p>
          </div>
        </div>
      </section>
