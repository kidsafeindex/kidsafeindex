      ...
      <section className="border-b border-slate-200">
        <div className="mx-auto max-w-4xl px-6 py-16">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-600">
            These terms explain the basic rules for using KidSafe Index. They
            are meant to be clear, practical, and easy to understand.
          </p>
        </div>
      </section>
        ...
        <div className="space-y-12">
          ...
          <div className="rounded-2xl border border-slate-200/80 bg-sky-50/50 p-6 shadow-sm">
            ...
            <h2 className="mt-3 text-2xl font-bold text-slate-800">
              KidSafe Index Is a Guide, Not a Guarantee
            </h2>
            <p className="mt-4 leading-7 text-slate-700">
              The site is designed to help parents ask better questions, better
              understand risk, and take more informed next steps. It is not a
              guarantee of safety or an assurance that harm can always be
              prevented.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-4 leading-7 text-slate-700">
              If you submit information through the site, including through
              contact forms or update signups, you agree not to send unlawful,
              abusive, deceptive, or malicious content. You also agree not to
              attempt to disrupt, misuse, or interfere with the site or its
              underlying systems.
            </p>
          </div>
